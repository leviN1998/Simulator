...
#filename = "../data/videos/hummingbird_video.mp4"
filename = "../data/videos/media2.mp4"
...
dvs.init_bgn_hist("../data/noise/noise_pos_161lux.npy", "../data/noise/noise_neg_161lux.npy")
...
ev_full.write('../data/outputs/ev_{}_{}_{}_{}_{}_{}.dat'.format(lat, jit, ref, tau, th_pos, th_noise))